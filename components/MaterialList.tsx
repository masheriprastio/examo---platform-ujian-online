    ...
    <div className="bg-white rounded-[40px] shadow-sm border border-gray-100 overflow-hidden">
      ...
      {materials.length === 0 ? (
        <div className="text-center py-16 bg-gray-50 rounded-[40px] border border-dashed border-gray-200">
          <p className="text-gray-400 font-medium">Belum ada materi yang diunggah.</p>
        </div>
      ) : (
              ...
              {materials.map((material) => {
                ...
                return (
                  <tr key={material.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-6">
                      <span className="bg-indigo-50 text-indigo-600 text-[10px] font-black uppercase px-3 py-1 rounded-full border border-indigo-100 tracking-widest">
                        {material.category}
                      </span>
                    </td>
                    <td className="px-6 py-6 text-gray-500 font-medium">
